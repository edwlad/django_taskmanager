...
- База данных [MariaDB](https://mariadb.org/).
...
При выборе пункта меню ***"API"*** выводится вэб интерфейс фреймворка Django REST framework. Работает простой фильтр по имени поля и точному совпадению значений. Например:  
