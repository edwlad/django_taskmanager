...
При выборе пункта меню ***"Поиск"*** выводятся списки не заверщённых проектов, спринтов и задач. Можно использовать фильтрацию по статусу и автору. Кнопки отображаются согласно прав пользователя. Поиск производится не зависимо от регистра в названиях проектов, спринтов и задач.
