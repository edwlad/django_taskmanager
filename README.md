...
При редактировании задачи проект выбирается из списка не закрытых проектов. Спринт выбираетя из списка не закрытых спринтов проекта (список пересоздаётся при выборе проекта). Родительская задача выбирается из списка не закрытых задач спринта, если выбран спринт.
